...
function Page() {
    ...
    const handleSubmit = (e) => {
        ...
        dispatch(solveTheExam({ data: req, examId }))
            .then(() => {
                // إعادة جلب بيانات الطلاب للتأكد من تحديث حالة الحل في Redux
                dispatch(fetchStudents());
            })

        // تحديث حالة العرض الفوري
        setIsSubmitted(true)
        setUserExamSolved({ submittedData: req }); // يمكن استخدام البيانات المرسلة للعرض الفوري
    }
